...
namespace FazaBoa_API.Models
{
    public class ApplicationUser : IdentityUser
    {
        ...
        public string ProfilePhotoUrl { get; set; } = "/profile-photos/default-user.png";
        ...
        {
            ProfilePhotoUrl = "/profile-photos/default-user.png"; // Definindo foto padrão no construtor
        }
    }
}
